...
% TODO: adjust Figure to match updated text.
...
%todo del
%Each objective describes how a newly developed artifact is expected
%to support a solution to a problem.
%As stated in the previous paragraph,
%the research problem is divided into distinct items,
%for each of which a use case is formulated.
%Later in the research process,
%for each use case,
%an artifact is designed and developed, demonstrated in context,
%and finally evaluated against the objectives.
\bigskip

% TODO: maybe illustrate    problem -> objective
