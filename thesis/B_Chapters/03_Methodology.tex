...
\begin{figure}[h]
	\centering
	\fbox{\includegraphics[width=1.00\linewidth]{figures/dsrm-process-release-promotion-gitops.png}}
...
%These questions can be seen in section \ref{appendix:interview-questions} in the appendix.
...
%The DSRM methodology is applied as described in section
%\ref{methodology:approach}.
%Activities 1 and 2 are supported by semi-structured interviews
%with practicing professionals.
%Activity 3 is done with the application of the prototyping method.
%Activities 4 and 5 are supported by the qualitative
%and descriptive 
...
%\ref{theoretical-background:gitops} \nameref{theoretical-background:gitops}
%of this thesis.
...
The \textit{what} of the evaluation makes statements about which properties the prototype should have
...
Finally, evolutionary prototyping is an incremental project work approach that involves developing 
