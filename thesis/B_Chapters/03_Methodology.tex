...
\textbf{Preparing the Interviews}:
As an initial step,
...
\textbf{Conducting the interviews}:
...
\textbf{Transcription and post-processing of the interviews}:
