...
\begin{figure}[h]
	\centering
	\fboxsep0mm\fbox{\includegraphics[width=0.98\linewidth]{assets/prom-pr-dev-to-qa.png}}
...
\begin{figure}[h]
	\centering
	\fboxsep0mm\fbox{\includegraphics[width=0.98\linewidth]{assets/prom-pr-dev-to-qa-round2.png}}
