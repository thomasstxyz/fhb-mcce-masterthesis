...
%    \LARGE{\yourThesisTitle}
	\LARGE{Strategies for Promoting Releases in GitOps Environments}
\end{flushleft}
...
\patchcmd{\chapter}{\clearpage}{\leavevmode\flushleft\justifying}{}{}
\makeatother

\vspace{5em}
\begin{abstract}
    \input{A_FrontMatter/abstract-thesisbook}
\end{abstract}
\vspace{2em}
